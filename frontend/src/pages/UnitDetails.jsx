...
//         {/* NEW: Unit Layout Section - Add this AFTER the monthly stats */}
//         {unit.layoutImage && (
//           <div style={{ 
//             marginBottom: '2rem',
//             padding: '1.5rem',
...
//               fontStyle: 'italic'
//             }}>
//               Floor plan for Unit {unit.unitNumber}
...
const UnitDetails = () => {
  ...
  const [loading, setLoading] = useState(true)
  const [error, setError] = useState(null)
  const [currentImageIndex, setCurrentImageIndex] = useState(0) // NEW: For carousel
  ...
  // NEW: Get all available images for carousel
  const getAllImages = () => {
    if (!unit) return []
    ...
    if (unit.imageURL) {
      images.push(getImageUrl(unit.imageURL))
    }
    ...
    if (images.length === 0) {
      images.push('https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80')
    }
      ...
      <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
        <div style={{ 
              ...
              {images.map((image, index) => (
                <img
                  ...
                  style={{
                    ...
                    borderRadius: '8px',
                    cursor: 'pointer',
                    border: index === currentImageIndex ? '3px solid #3498db' : '3px solid transparent',
          ...
          <div style={{ 
            ...
            {images.some(img => img.includes('cloudinary.com')) && (
